...
/**
 * @extends ServiceEntityRepository<Forfaits>
 *
...
class ForfaitsRepository extends ServiceEntityRepository
{
    ...
    public function save(Forfaits $entity, bool $flush = false): void
    {
    ...
    public function remove(Forfaits $entity, bool $flush = false): void
    {
